...
import type { UVTSource } from "../data/UVTSource";
...
export abstract class Simulation<Program extends SimProgram = SimProgram> {
  ...
  public abstract get textureFilter(): number;
   ...
   */
  public update(timeStep: number, steps = 0) {

    console.log({ timeStep, steps });
