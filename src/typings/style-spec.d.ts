...
declare module 'mapbox-gl/dist/style-spec' {    // Generated by dts-bundle-generator v6.12.0
    ...
    //     }
    //     export function createPropertyExpression(expression: StyleExpression, propertySpec: StylePropertySpecification): Result<StylePropertyExpression, Array<ParsingError>> {
