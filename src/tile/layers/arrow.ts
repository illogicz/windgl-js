...
export class Arrows extends TileLayer<ArrowProps> {

  constructor(options: ArrowOptions, source: WindSource) {
    super(
      {
        "arrow-min-size": {
          type: "number",
  ...
  public draw(gl: WebGLRenderingContext, matrix: mat4, tile: Tile, offset: Float32List) {
