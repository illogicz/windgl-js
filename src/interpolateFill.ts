// import { TileLayer, LayerOptions } from "./tileLayer";
// import * as util from "./util";

// import type { mat4 } from "gl-matrix";
// import type * as mb from "maplibre-gl";
// //import { interpolateFill } from "./shaders/interpolateFill.glsl";
// //import { WindTexturePair } from "./timeSource";


// export type InterpolateFillProps = "sample-opacity" | "sample-fill-color";
// export type InterpolateFillOptions = LayerOptions<InterpolateFillProps>

// export class InterpolateLayer extends TileLayer<InterpolateFillProps> {
//     constructor(options: InterpolateFillOptions) {
//         super(
//             {
//                 "sample-fill-color": {
//                     type: "color",
...
//         this.program = interpolateFill(gl);
//         this.quadBuffer = util.createBuffer(
//             gl, new Float32Array([0, 0, 1, 0, 0, 1, 0, 1, 1, 0, 1, 1])
//         );
//     }
...
//     draw(gl: WebGLRenderingContext, matrix: mat4, data: WindTexturePair, offset: Float32Array) {
...
//         util.bindTexture(gl, data.tex1!(gl), 0);
//         util.bindTexture(gl, this.colorRampTexture!, 2);

//         gl.uniform1i(program.u_wind_1, 0);
//         gl.uniform1i(program.u_wind_2, 1);
